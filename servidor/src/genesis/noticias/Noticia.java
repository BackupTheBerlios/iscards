...
/**
 *  Cada objeto de esta clase agrupa los elementos que conforman una noticia
 *  en la base de datos.
 *
 *@author    Laura Garcia
 */
public class Noticia {
	...
	/**
	 *  Constructor para el objeto Noticia. No especifica identificador.
	 *
	 ...
	 *
	 *@param  nId   Identificador de la noticia
	 *@param  tit   Título de la noticia
	 *@param  tip   Tipo de la noticia: Aviso, Novedad, etc..
	 *@param  cont  Cuerpo de la noticia
	 *@param  fech  Fecha de creación
