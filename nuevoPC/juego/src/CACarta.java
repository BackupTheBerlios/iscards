...
public abstract class CACarta implements Cloneable {
   ...
   *
   */
  protected String dirD; //direccion de la foto (esto sobraría, en principio vale con la variable imagen)
  ...
  /**
   * nombre de la raza a la que pertenece la carta (Angeles, Demonios, Humanos, Inmortales)
   */
  ...
  /**
   * true = activa ; false = girada
   */
  protected boolean estado; //true activa, false tapada

  protected boolean bajada = false; //mano = true y  mesa= false
  /**
   *
   * @return
   */
  ...
  /**
   * funicion que devuleve los atributos de una carta en formato de
   * texto semejante a clips para poder procesarla mediante la
