...
public class LoginImp extends LoginGUI {
  ...
  public void botonNuevo_actionPerformed(ActionEvent e){
    ...
    SolicitarNombreImp solicitud = new SolicitarNombreImp(this, coleccion);
    solicitud.show();
  }
  ...
  public void botonCargar_actionPerformed(ActionEvent e){
    try{
      ...
      if(usuarioSelec!=-1){
        ...
        JOptionPane.showMessageDialog(this, "Tienes que elegir un usuario antes!!", "Usuario", JOptionPane.INFORMATION_MESSAGE);
    }
    catch (Exception error) {
      //mostramos con un JOptionPane el error producido
  ...
  public void botonBorrar_actionPerformed(ActionEvent e){
    try {
      ...
      if (usuarioSelec != -1){
        ...
        int borrar = JOptionPane.showConfirmDialog(this, "Desea borrar al usuario?", "Confirmación",
