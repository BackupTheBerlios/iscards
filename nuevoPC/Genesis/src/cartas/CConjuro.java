 ...
 *  Título: GENESIS</p> <p>
 *
 *  Descripción: Clase que implementa a los objetos de tipo carta Conjuro</p>
 *  <p>
 *
...
//    estado=true;
	 ...
	 *
	 *@param  dur  Description of Parameter
	...
	public boolean ejecuta() {
		...
		int aux;
		boolean error = false;
		Integer valor1 = new Integer(0);
		//Aqui se almacena la magnitud del efecto
		Integer valor2 = new Integer(0);
		//mas significativo en posiciones mas bajas
	...
	/**
	 *  Funcin que devuleve los atributos de una carta de tipo conjuro en formato
	 *  de texto semejante a clips para poder procesarla mediante la inteligencia
	 *  artificial
	 *
	 *@return
	 */
	public String dame_clips() {
		...
		String d = " (defensa 0)";
		// ponemos a 0 para mantener el formato de clips
		String v = " (vidas 0)";
		//
