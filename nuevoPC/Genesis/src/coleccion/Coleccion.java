...
public class Coleccion {
	...
	/**
	 *  Variable en la cual se guardaran las cartas de la colección a partir de
	 *  los códigos
	 */
	private Hashtable BBDDCartas;

	/**
	 *  Variable en la cual se guardaran los códigos de las cartas a partir de
	 *  los nombres
	 */
